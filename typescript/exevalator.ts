...
class ErrorMessages {
    ...
    public static readonly ADDRESS_MUST_BE_ZERO_OR_POSITIVE_INT32 = "The address must be zero or a positive 32-bit integer: '$0'";
    public static readonly FUNCTION_ERROR = "Function Error ('$0'): $1";
    public static readonly VARIABLE_NOT_FOUND = "Variable not found: '$0'";
    public static readonly FUNCTION_NOT_FOUND = "Function not found: '$0'";
    public static readonly UNEXPECTED_OPERATOR = "Unexpected operator: '$0'";
    public static readonly UNEXPECTED_TOKEN = "Unexpected token: '$0'";
    public static readonly ARGS_MUST_NOT_BE_NULL_OR_UNDEFINED = "The argument(s) must not be null or undefined: '$0'"
    public static readonly TOO_LONG_EXPRESSION = "The length of the expression exceeds the limit (StaticSettings.MAX_EXPRESSION_CHAR_COUNT: '$0'";
    public static readonly UNEXPECTED_ERROR = "Unexpected error occurred: $0";
    public static readonly REEVAL_NOT_AVAILABLE = "\"reeval\" is not available before using \"eval\"";
    public static readonly TOO_LONG_VARIABLE_NAME = "The length of the variable name exceeds the limit (StaticSettings.MAX_NAME_CHAR_COUNT: '$0'";
    public static readonly TOO_LONG_FUNCTION_NAME = "The length of the function name exceeds the limit (StaticSettings.MAX_NAME_CHAR_COUNT: '$0'";
...
class LexicalAnalyzer {
    ...
    public static analyze(expression: string): Token[] {
        ...
        if (tokenWords.length == 1 && tokenWords[0].length == 0) {
            throw new ExevalatorError("The inputted expression is empty");
        }
